...
class PseudoColor: CIFilter
{
    ...
    override var outputImage: CIImage!
    {
        ...
        let arguments: [Any] = [inputImage, inputSmoothness, inputColor0, inputColor1, inputColor2, inputColor3, inputColor4]
...
class PolarPixellate: CIFilter
{
    ...
    var inputPixelArc = CGFloat(CGFloat.pi / 15)
    ...
    override func setDefaults()
    {
        inputPixelArc = CGFloat(Double.pi / 15)
        inputPixelLength = 50
